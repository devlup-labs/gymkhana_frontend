  ...
  v-navigation-drawer(v-model="drawer" app temporary width="250")
    v-card(tile text ripple color="blue" height="200")
      ...
      v-card-text
        v-layout.pt-1
          v-flex
            p.white--text.font-weight-bold Name
        v-layout.pt-1
          v-flex
            p.white--text.font-weight-bold Email
    v-list.pa-0.pt-2(nav shaped).me-5
      v-list-item-group(color="primary")
        v-list-item( link)
          v-list-item-icon
            v-icon(light) mdi-account
          v-list-tile-content
            v-list-tile-title Profile
        v-list-group(color="primary")
          v-list-item(slot="activator").pa-0
            v-list-item-icon
              v-icon mdi-database
            v-list-tile-content
          ...
          v-list-item(@click="" link).ms-10
            v-list-tile-content
              v-list-tile-title All Questions
          v-list-item(@click="" link).ms-10
            v-list-tile-content
